...
def test_new_account_bad_registration(account_page):
    ...
    account_page.fill_login_form(
        'test', 'test',
        '53535fsdfsdf', '53535fsdfsdf')
    account_page.check_text_in_page_bad_add_account_registration(
        'Minimum of different classes of '
...
def test_check_text_account(account_page):
    account_page.open_page()
    account_page.check_text_account(
